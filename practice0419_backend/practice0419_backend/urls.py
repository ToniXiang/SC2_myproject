...
from myapp.views import RegisterView,CustomAuthToken,ProductListView,OrderView,UserView,SendVerificationCodeView,ResetPasswordView
...
urlpatterns = [
    ...
    path('api/orders/<int:order_id>/cancel/', OrderView.as_view(), name='orders_cancel'),
]
